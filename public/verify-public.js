...
// ======================================================
// 🌍 UDoChain Verify Public — CLON EXACTO DE PRIVATE
// Lee ?storage= igual que verify-private v5.0
// ======================================================
...
// ------------------------------------------------------
// 🔗 API BASE IGUAL QUE PRIVATE
// ------------------------------------------------------
const API_BASE = "https://api.udochain.com";

// ======================================================
// 🧠 Load validation (MISMA LÓGICA QUE PRIVATE)
// ======================================================
async function loadValidation() {
  if (!storage) {
    detailsDiv.innerHTML =
  ...
  try {
    ...
    // --------------------------------------------------
    // 🧾 Render evidence (igual estructura)
    // --------------------------------------------------
    detailsDiv.innerHTML = `
      <div class="field">
        <span class="label">Evidence Title:</span>
    ...
    // --------------------------------------------------
    // 🔐 Cache hashes para verificación local
    // --------------------------------------------------
    window.validatedFiles =
      data.files?.map((f) => f.hash.toLowerCase()) || [];
